...
public class BattleCraft extends JFrame {
    ...
    public BattleCraft() {
        ...
        lblCreeperName.setBounds(689, 10, 234, 426);
    ...
    private void loadNextMonster() {
        if (monsterIndex < monsters.length) {
            ...
            String imagePath = currentMonster.getImagePath(); // 예: "/image/Zombie.png"
            ImageIcon rawIcon = new ImageIcon(BattleCraft.class.getResource(imagePath));
            Image scaled = rawIcon.getImage().getScaledInstance(350, 400, Image.SCALE_SMOOTH);
